...
import ani.sanin.databinding.FragmentNotificationsBinding
...
class NotificationFragment : Fragment() {
    ...
    private suspend fun getList() {
        val list = when (type) {
            ...
            MEDIA -> getNotificationsFiltered(type = true) { it.media != null || it.notificationType == ani.sanin.connections.anilist.api.NotificationType.MEDIA_DELETION.value }
            USER -> getNotificationsFiltered { it.media == null && it.notificationType != ani.sanin.connections.anilist.api.NotificationType.RELATED_MEDIA_ADDITION.value }
