...
import ani.sanin.databinding.ItemNotificationBinding
...
class NotificationItem(
    ...
    private fun getNotificationTypeIcon(notificationType: NotificationType): Int {
        return when (notificationType) {
            ...
            NotificationType.SANIN_UPDATE -> R.drawable.ic_round_notifications_active_24
        }
    }
    ...
    private fun image(
        ...
        if (user) {
            ...
            if (commentNotification) {
                binding.notificationCoverUser.setImageResource(R.drawable.ic_sanin_round)
