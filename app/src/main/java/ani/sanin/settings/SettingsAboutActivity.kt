...
import ani.sanin.databinding.ActivitySettingsAboutBinding
                ...
                arrayListOf(
                    ...
                    Settings(
                        ...
                        onClick = {
                            val text = TextView(context)
                            val pPLink =
                                "https://raw.githubusercontent.com/rebelonion/Sanin/main/privacy_policy.md"
                            val backup =
                                "https://gcore.jsdelivr.net/gh/rebelonion/sanin/privacy_policy.md"
