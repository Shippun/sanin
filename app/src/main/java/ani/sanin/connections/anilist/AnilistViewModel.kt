...
import ani.sanin.others.AppUpdater
import ani.sanin.profile.User
import ani.sanin.settings.saving.PrefManager
import ani.sanin.settings.saving.PrefName
import ani.sanin.snackString
import ani.sanin.connections.syncPendingProgressUpdates
import ani.sanin.connections.syncPendingDeletions
...
class AnilistHomeViewModel : ViewModel() {
    ...
    private val trendingBanner: MutableLiveData<ArrayList<Media>> =
        MutableLiveData<ArrayList<Media>>(null)

    fun getTrendingBanner(): LiveData<ArrayList<Media>> = trendingBanner

    suspend fun loadTrendingBanner() {
