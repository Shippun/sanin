package ani.sanin.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.sanin.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.sanin.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: ani.sanin.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.sanin.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.sanin.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.sanin.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.sanin.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.sanin.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.sanin.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.sanin.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.sanin.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.sanin.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("missingSequelsCompletedQuery") val missingSequelsCompletedQuery: ani.sanin.connections.anilist.api.MediaListCollection?,
            @SerialName("missingSequelsAllListQuery") val missingSequelsAllListQuery: ani.sanin.connections.anilist.api.MediaListCollection?,
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: ani.sanin.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: ani.sanin.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.sanin.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.sanin.connections.anilist.api.Page?,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: ani.sanin.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: ani.sanin.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: ani.sanin.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.sanin.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.sanin.connections.anilist.api.Page?,
        )
    }
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.sanin.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.sanin.connections.anilist.api.User>?
    ) : java.io.Serializable
