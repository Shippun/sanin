package ani.sanin.connections.github

import ani.sanin.client
import ani.sanin.settings.Developer
...
class Contributors {
    ...
    suspend fun getContributors(): Array<Developer> {
        ...
        try {
            val res =
                client.get("https://git.rebelonion.dev/rebelonion/Sanin/activity/contributors/data")
