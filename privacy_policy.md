...
## Introduction
This Privacy Policy describes how we collect, use, and handle your information when you use Sanin. We are committed to protecting your privacy and ensuring transparency about our data practices.
...
Firebase Analytics collects anonymous usage data, including country-level geolocation information. This helps us understand how Sanin is being used across different regions.

### Third-Party Authentication and Integration
Sanin allows you to authenticate with the following third-party services:
- AniList
- MyAnimeList
- Discord
...
This information is only shared while you are actively using Sanin and have Discord RPC enabled.
...
### Comments System
Our in-house comments API uses your AniList authentication token for verification purposes when you initially open Sanin. While this token is used for authentication, it is never stored on our servers. We only store:
...
- GitHub: [Sanin Issues](https://github.com/rebelonion/Sanin/issues)
- Discord: "@rebelonion"
- AniList: "rebelonion"
